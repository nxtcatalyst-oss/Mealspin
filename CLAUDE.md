...
Also, use Opus-4.6 for everything while building. It has a 1M token context, 128K output, agent teams, and adaptive thinking. Model ID: claude-opus-4-6-20260205.